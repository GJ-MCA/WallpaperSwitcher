...
public class MyWorker extends Worker {
    ...
    public Result doWork() {
        ...
        Log.d(TAG, "Service Running: " + com.vpn.wallpaperswitcher.Services.MyService.isServiceRunning);
        if (!com.vpn.wallpaperswitcher.Services.MyService.isServiceRunning) {
            Log.d(TAG, "starting service from doWork");
            Intent intent = new Intent(this.context, com.vpn.wallpaperswitcher.Services.MyService.class);
